...
const QuestionSet: FC<any> = (): ReactElement => {
  ...
  function handleSubmit() {
    ...
    <Alert severity="error">
      Unfortunately you did not win the Badge.you can re-attempt the quiz to
      win!
    </Alert>;
  }
  ...
  const handleChange = (
    ...
    setValue({
      ...
      selectedOpt: (event.target as HTMLInputElement).value,
    });
  ...
  return (
    ...
    >
      <Box sx={{ my: 3, mx: 2, color: "primary.dark", width: "100%" }}>
        ...
        >
          <List
            sx={{ width: "100%", m: "4", height: "100%", overflowY: "scroll" }}
          >
            {question.map((q) => {
              return (
                <ListItem key="">
        ...
        <Box mt={4}>
          <Button
            sx={{ color: "#6558F4", border: "1px solid #6558F4" }}
            variant="outlined"
            type="submit"
            size="large"
