...
/**
 * Test for /api/v1/Visitor/Quiz/list
 */
Test('/api/v1/Visitor/Quiz/list', function (t) {
        ...
        t.test('test  get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/api/v1/Visitor/Quiz/list']['get']['responses']['200']['schema']);
