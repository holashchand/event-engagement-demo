...
/**
 * Test for /api/v1/Visitor/visit/{exhibitOsid}
 */
Test('/api/v1/Visitor/visit/{exhibitOsid}', function (t) {
        ...
        t.test('test  put operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/api/v1/Visitor/visit/{exhibitOsid}']['put']['responses']['200']['schema']);
