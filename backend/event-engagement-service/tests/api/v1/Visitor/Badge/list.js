...
/**
 * Test for /api/v1/Visitor/Badge/list
 */
Test('/api/v1/Visitor/Badge/list', function (t) {
        ...
        t.test('test  get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/api/v1/Visitor/Badge/list']['get']['responses']['200']['schema']);
