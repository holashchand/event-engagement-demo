...
/**
 * Test for /api/v1/Quiz/getQuestions/{exhibitionId}
 */
Test('/api/v1/Quiz/getQuestions/{exhibitionId}', function (t) {
        ...
        t.test('test  get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/api/v1/Quiz/getQuestions/{exhibitionId}']['get']['responses']['200']['schema']);
