...
/**
 * Test for /api/v1/Quiz/submit/{exhibitionId}
 */
Test('/api/v1/Quiz/submit/{exhibitionId}', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
        ...
        t.test('test  post operation', function (t) {
            Mockgen().requests({
                path: '/api/v1/Quiz/submit/{exhibitionId}',
                operation: 'post'
            }, function (err, mock) {
                var request;
                t.error(err);
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/api/v1/Quiz/submit/{exhibitionId}']['post']['responses']['200']['schema']);
