...
/**
 * Test for /api/v1/QRCode/{userDid}/verify
 */
Test('/api/v1/QRCode/{userDid}/verify', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
        ...
        t.test('test  get operation', function (t) {
            Mockgen().requests({
                path: '/api/v1/QRCode/{userDid}/verify',
                operation: 'get'
            }, function (err, mock) {
                var request;
                t.error(err);
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/api/v1/QRCode/{userDid}/verify']['get']['responses']['200']['schema']);
