...
/**
 * Test for /api/v1/Visitor/details
 */
Test('/api/v1/Visitor/details', function (t) {
        ...
        t.test('test  get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/api/v1/Visitor/details']['get']['responses']['200']['schema']);
