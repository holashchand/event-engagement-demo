...
/**
 * Test for /api/v1/Exhibit/search
 */
Test('/api/v1/Exhibit/search', function (t) {
        ...
        t.test('test  post operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/api/v1/Exhibit/search']['post']['responses']['200']['schema']);
